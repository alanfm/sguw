    ...
    return (
        <nav className="flex items-end justify-between gap-2 pt-6">
            ...
            <div className="flex flex-col justify-end items-end">
                ...
                <p className="flex items-end text-xs font-light text-gray-500">
                    Total de registros<strong className="font-semibold">&nbsp;{count}&nbsp;</strong> - Página<strong className="font-semibold">&nbsp;{data.current_page}&nbsp;</strong>de<strong className="font-semibold">&nbsp;{data.last_page}</strong>.
                </p>
            </div>
        </nav>
    )
