...
export default function Form({data, errors, handleSubmit, onHandleChange, processing }) {
    return (
        <form onSubmit={handleSubmit} autoComplete="off">
            ...
            <div className="mb-4">
                <label htmlFor="value" className="font-light">Dispositivos simultâneo</label>
                <Input type="number" value={data.value} name={'value'} handleChange={onHandleChange} required={true} placeholder="Quantidade de dispositivos" />
                <InputError message={errors.value} />
            </div>
            <div className="mb-4">
                <label htmlFor="priority" className="font-light">Prioridade</label>
                <Input type="number" value={data.priority} name={'priority'} handleChange={onHandleChange} required={true} placeholder="Nível da prioridade" />
